module.exports = {
  ...
  '/design-pattern/': require('./design-pattern'),

  '/algorithm/': require('./algorithm'),
  
  '/data-structure/': require('./data-structure'),

  '/specification/': require('./specification'),

  '/networking/http': require('./networking/http'),
  '/networking/ssh': require('./networking/ssh'),
